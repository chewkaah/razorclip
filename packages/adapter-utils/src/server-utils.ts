...
export function renderPaperclipWakePrompt(
  ...
  const lines = resumedSession
      ? [
        ...
        "If the latest comments correct your prior interpretation, replace the old interpretation immediately and act on the correction.",
        "A direct human instruction or named assignee in the latest comments beats keyword matching from older context.",
