...
export function ChatLayout({ companyId, threadId }: ChatLayoutProps) {
  ...
  return (
    <div className="flex h-[calc(100dvh-4rem)] -m-4 md:-m-8 bg-[#111319]">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        {threadId ? (
          ...
          <div className="flex flex-col items-center justify-center h-full gap-4 bg-[#111319] px-4">
            ...
            <p className="text-sm text-[#c7c4d7]/50 text-center">
            ...
            <button
              ...
              className="md:hidden flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#c2c1ff]/10 border border-[#c2c1ff]/20 text-[#c2c1ff] text-xs font-bold uppercase tracking-wider hover:bg-[#c2c1ff]/20 active:scale-95 transition-all"
            >
      ...
      <div className="hidden md:block fixed top-20 right-0 h-2/3 w-1.5 bg-[#c2c1ff]/20 rounded-l-full" />
    </div>
  );
}
